...
class Blockchain {
  ...
  createGenesisBlock() {
    return new Block(0, "11/04/22", "first block on the chain", "0");
  }
...
console.log("mining logcoin in process...");
...
console.log(logCoin.validateChangeIntegrity());
